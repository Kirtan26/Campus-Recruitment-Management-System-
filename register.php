...
<html>
      ...
      <nav class="navbar navbar-default" style="margin-bottom: 0; height: 80px; background-color: white; border-color: transparent;">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            <a class="navbar-brand" style="font-size: 24px; color: #053a5a; line-height: 42px;" href="index.php">Campus Recruitment Management System </a>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="date" id="dob" name="dob" placeholder="Date of Birth *" min="1985-01-01" max="2005-01-01" required="">
              </div>
  ...
  <footer id="footer" style="background-color: #053a5a; height: 80px;">
    ...
    <p style="color:white; font-size: 20px; line-height: 80px; text-align: center;"> 
       <a href="index.php" style="color:white;">Campus Recruitment Management System  </a>
    </p>
